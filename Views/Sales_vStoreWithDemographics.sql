...
EXEC sys.sp_addextendedproperty N'MS_Description', N'Stores (names and addresses) that sell Adventure Works Cycles products to consumers.', 'SCHEMA', N'Sales', 'VIEW', N'vStoreWithDemographics'
GO